---
description: >
  Mandatory implementation controller. Orchestrates task implementation
...
1. **Layered Detection**:
   ...
   - **Layer 2 (Composite TDD + Critique Fallback)**: If Layer 1 is absent, check for `test-driven-development/SKILL.md`.
